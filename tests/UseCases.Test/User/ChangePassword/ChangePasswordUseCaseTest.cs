...
public class ChangePasswordUseCaseTest
{
    ...
    private static ChangePasswordUseCase CreateUseCase(MyRecipeBook.Domain.Entities.User user, string? email = null)
    {
        ...
        return new ChangePasswordUseCase(loggedUser,updateRepositoryBuilder,unitOfWork,passwordEncrypter);
    }
}